...
Vec3 vec3_modulate(Vec3 a, Vec3 b) { return vec3_new(a.x * b.x, a.y * b.y, a.z * b.z); }
...
Vec4 vec4_modulate(Vec4 a, Vec4 b) { return vec4_new(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w); }
...
Mat3 mat3_inverse(Mat3 m) { return Mat3ranspose(mat3_inverse_transpose(m)); }
...
Mat4 mat4_from_trs(Vec3 t, Quat r, Vec3 s) {
    Mat4 translation = Mat4ranslate(t.x, t.y, t.z);
    Mat4 rotation    = mat4_from_quat(r);
    Mat4 scale       = mat4_scale(s.x, s.y, s.z);
...
Mat4 mat4_inverse(Mat4 m) { return Mat4ranspose(mat4_inverse_transpose(m)); }
